...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            @include('cpanel.almacen.almacen.partials.report')
    ...
    <div class="row">
      <div class="col-sm-12">
          @include('cpanel.almacen.almacen.partials.search')
      </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <div class="table-rep-plugin">
                    <div class="table-responsive" data-pattern="priority-columns">
                        @include('cpanel.almacen.almacen.partials.table')
                    </div>
    ...
    <div class="col-lg-12">
        <div class="pull-left">
            {{$almacenes->appends(Request::only(['s']))->render()}}
        </div>
    </div>
@endsection
@section('css')
